...
public class TransactionHistoryDetailsDialog extends JDialog{
        public TransactionHistoryDetailsDialog(Window owner, String issuer, String recepient, String IBAN, String amount, String date, String rf, String frequency, String nextPayment, String amountPerBill, String remPayments, String status) {
        ...
        addDetail(infoPanel, c, 10, "Status:", status);
