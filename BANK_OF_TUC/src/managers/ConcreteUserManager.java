...
public class ConcreteUserManager implements UserManager{
	...
	private static ConcreteUserManager instance;
	private UserDAO userDao;
	private HashMap<Long,AccountOwner> users;
	
	private ConcreteUserManager() {
		this.userDao = (UserDAO) DAOFactory.createDAOFactory("users");
		this.users = new HashMap<Long, AccountOwner>();
	}
	
	public static ConcreteUserManager getUserManager() {
		if(instance == null) {
			instance = new ConcreteUserManager();
			return instance;
		}
		else
			return instance;
